...
public class PowerUsageSummary extends PowerUsageBase implements OnLongClickListener,
    ...
    protected void refreshUi(@BatteryUpdateType int refreshType) {
        ...
        mBatteryTemp.setSubtitle(
                com.android.internal.util.aquarios.AquaUtils.mccCheck(getContext()) ?
                com.android.internal.util.aquarios.AquaUtils.batteryTemperature(getContext(), true) + "°F" :
                com.android.internal.util.aquarios.AquaUtils.batteryTemperature(getContext(), false) + "°C");
    }
